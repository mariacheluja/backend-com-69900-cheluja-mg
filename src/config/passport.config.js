...
//   // Estrategia de login
//   passport.use(
//     "login",       // el profesor uso register
//     new LocalStrategy(
      
//         { usernameField: "email", passReqToCallback: true },
//         async (req, email, password, done) => {
//           try {
//             const user = await UserModelodel.findOne({ email });
...
const initializePassport = () => {
  ...
  // **Eliminado un duplicado de la función `initializePassport`.**
...
// Función para extraer la cookie
function cookieExtractor(req) {
  let token = null;
  if (req && req.cookies) {
    token = req.cookies["token"];
