...
export const getAll = async (req, res, next) => {
  try {
    const { page, limit, title, category, sort} = req.query; // name en mi db es title
    const response = await service.getAll(page, limit, title, category,sort); //buscamos por name y hacemos un sort pero es opcional
